...
//Heavily based on tutorial from Jasoni: https://www.youtube.com/watch?v=FcnvwtyxLds
//And research from Jonathan Whiting https://jonathanwhiting.com/writing/blog/verlet_rope/
// and http://toqoz.fyi/game-rope.html
public class VerletRopeScript : MonoBehaviour
{
    ...
    private void ApplyConstraints()
    {
        ...
        startSegment.currentPos = Camera.main.ScreenToWorldPoint(Input.mousePosition);
    ...
    private Vector3 CircleCollisionConstraint(RopeSegment segment, GameObject collidedCircle)
    {
        ...
        if (distance - (spriteRenderer.bounds.size.x / 2) < 0)
        {
            ...
            if (!particle.shouldIgnoreForces)
            {
                ...
                //particle.Velocity = (segment.currentPos - segment.oldPos)*stiffness;
            }
            return hitPos;
        }
        else 
